        ...
        <div class="contiainer">
            <div class="col-md-5 m-auto  py-5 px-3">
                <div class="bg-blue rounded-2 py-5 px-2">
                    ...
                    " class="">
                        <h3 class="text-center mb-3 p-2 text-warning border-bottom border-warning">إضافة فاتورة</h3>
                        ...
                        <div class="col-md-8 m-auto form-group  py-2">
                            <input type="submit" name="submit" class="btn btn-warning w-100 text-white" value="إضافة الفاتورة">
                        </div>
                    </form>
                </div>
